...
- Solution URL: [Add solution URL here](https://github.com/kephalosk/qr-code-component-main)
- Live Site URL: [Add live site URL here](https://kephalosk.github.io/qr-code-component-main/)
...
I learned to include fonts via link:
```html
